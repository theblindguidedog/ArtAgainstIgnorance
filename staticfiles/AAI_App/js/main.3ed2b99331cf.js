jQuery(function ($) {
    ...
    (function () { 
        ...
        $(".body-background-slider").backstretch([ "static/AAI_App/aai_images/bg/webp/texture-background-small.webp"]);//(was)static/AAI_App/aai_images/slider/grey-background.jpg
